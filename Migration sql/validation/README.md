...
# 12. Phase 9 (exam_analytics): apply + smoke
psql -v ON_ERROR_STOP=1 -f "supabase/migrations/20260711170000_exam_analytics.sql"
psql -f "Migration sql/validation/exam_analytics_smoke_tests.sql"
```
