...
import { Bell, MessageCircle, FileCheck, Clock, Percent, IndianRupee, Loader2, Check, AlertCircle } from 'lucide-react'
...
export default function SettingsForm({ school }: { school: SchoolSettings }) {
