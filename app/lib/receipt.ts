...
.sheet{display:flex;align-items:stretch;gap:6mm;padding:3mm 2mm 0}
...
<div class="hcut"><span>✂ cut vertically between the two copies, then cut here — feed the lower half back in for the next student</span></div>
</body></html>`
}
